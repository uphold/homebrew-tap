class AwsGoogleAuth < Formula
  ...
  desc "Acquire AWS credentials using Google Apps (uphold flavor)"
  homepage "https://github.com/uphold-forks/aws-google-auth"
  head "https://github.com/uphold-forks/aws-google-auth.git"
